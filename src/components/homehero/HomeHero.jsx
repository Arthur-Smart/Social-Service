            ...
            <div className='homehero-wrapper'>
                ...
                <div className='flex  flex-col mt-4'>
                    ...
                    <div className='location-button-2 items-center  justify-between  flex'>
                        ...
                        <button onClick={() => handleSearch()} className='text-white self-start search-q-btn bg-red-500 py-3 px-10  text-center'><p><i class="fa-solid fa-magnifying-glass fa-shake"></i></p></button>
                    </div>
