  ...
  return (
    <div className='recommend flex  items-center justify-center'>
      <div className='container flex-col flex items-center justify-center'>
        <p className='text-white text-3xl text-center'><span className='recommend-title text-amber-500 font-bold text-4xl'>SkillHub</span><br /> The Leading Skill Search for Your Business in Kenya.</p>
