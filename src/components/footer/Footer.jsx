    ...
    <div className='footer flex flex-col items-center justify-center py-10'>
        ...
        <div className='container footer-b-wrapper flex items-center justify-between'>
            ...
            <div className='foooter-right flex items-center'>
                <a href='https://web.facebook.com/profile.php?id=100064319250841' target='_blank'><p className='text-zinc-400 text-3xl'><i class="fa-brands fa-square-facebook"></i></p></a>
                <a href='https://www.instagram.com/exquitech.co/' target='_blank'> <p className='text-zinc-400 text-3xl ml-4' ><i class="fa-brands fa-square-instagram"></i></p></a>
                <a href='https://www.linkedin.com/in/arthur-mwangi-7a80761bb/' target='_blank'><p className='text-zinc-400 text-3xl ml-4' ><i class="fa-brands fa-linkedin"></i></p></a>
