    ...
    <div className='jobpage flex flex-col items-center justify-center'>
        ...
        <div className='similar-jobs mt-10 flex items-center justify-center py-2'>
            <div className='container'>
                <p className='text-amber-500  text-xl similar-title mt-4'>Other job posting by John Mwaniki | <span className='text-white font-bold'>20 other jobs</span></p>
        ...
        <div className='apply flex items-center'>
            <div className='apply-wrapper bg-white p-3 flex flex-col items-center justify-center'>
                ...
                <div className='w-full items-start flex items-center py-2 justify-between'>
                   <label className='flex-start border-2 text-white cursor-pointer border-amber-100 rounded-full py-2 px-5 mt-2 bg-amber-500' htmlFor='upload'>Upload Resume</label>
                    <button className='item-start  apply-btn py-2 px-4 rounded-full text-white'>Publish</button>
                </div>                
            </div>
            <p>close</p>
            <div>                
